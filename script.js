...
const questions = [
    {
        ...
        A: "철저한 계획을 세우고 그 계획을 따라 움직인다.",
        B: "일단 시작하고 상황에 따라 유연하게 대응한다."
    },
    {
        question: "나를 성장시키는 방식은 무엇에 가깝다고 생각하는가?",
        A: "꾸준한 루틴과 반복, 체계적인 학습을 통해 성장한다.",
        B: "다양한 경험과 도전을 통해 새로운 것을 배우며 성장한다."
    },
    {
        question: "중요한 결정을 내릴 때 나는 어떤 방식을 선호하는가?",
        A: "여러 가능성을 분석하고, 장단점을 따져 신중하게 결정한다.",
        B: "직감을 따르거나, 흐름에 몸을 맡겨보고 결정한다."
    },
    {
        question: "나의 일상은 어떤 패턴을 띠는가?",
        A: "정해진 틀과 규칙 안에서 안정적으로 유지된다.",
        B: "변화를 즐기고, 즉흥적인 요소를 많이 포함한다."
    },
    {
        question: "성취감을 가장 크게 느끼는 순간은 언제인가?",
        A: "나의 아이디어나 영향력이 외부로 확장되어 변화를 만들 때.",
        B: "내면의 균형을 찾고, 스스로 깊이 있는 성장을 이뤘다고 느낄 때."
    },
    {
        question: "다른 사람과 함께하는 활동에서 나는 어떤 역할에 더 끌리는가?",
        A: "팀을 이끌거나 새로운 방향을 제시하는 리더 역할을 선호한다.",
        B: "조율하고 지지하며, 팀 내 안정과 깊이를 더하는 역할을 선호한다."
    },
    {
        question: "새로운 분야에 도전할 때 나는 무엇에 더 흥미를 느끼는가?",
        A: "내 한계를 넘어서고, 새로운 가능성을 넓히는 것에 흥미를 느낀다.",
        B: "익숙해질 시간을 갖고, 내 것으로 만드는 과정에 집중한다."
    },
    {
        question: "나의 관심사는 주로 어떤 방향으로 발전하는가?",
        A: "다양한 분야로 넓혀가며 폭넓은 지식과 경험을 쌓는다.",
        B: "한 분야를 깊이 파고들어 전문성을 심화하는 데 집중한다."
    },
    {
        question: "예상치 못한 문제가 발생했을 때 나는 어떻게 대응하는가?",
        A: "가장 현실적인 해결 방안을 찾고, 즉시 실행에 옮긴다.",
        B: "문제의 본질을 이해하고, 감정적인 회복과 재정비를 우선한다."
    },
    {
        question: "나를 다시 일어서게 하는 근본적인 힘은 무엇인가?",
        A: "명확한 시스템, 루틴, 또는 구체적인 방법론.",
        B: "나를 지지하는 신념, 따뜻한 기억, 혹은 감정적인 공감."
    },
    {
        question: "위기 상황에서 누군가 조언을 해준다면 무엇을 더 선호하는가?",
        A: "구체적인 해결책이나 행동 지침을 듣고 싶다.",
        B: "나의 감정을 이해하고 공감해주는 따뜻한 위로를 원한다."
    },
    {
        question: "압박감 속에서 중요한 과제를 수행할 때 나의 태도는?",
...
const results = {
    ...
    "대월": {
        period: "약 968년 ~ 1802년 경 (리 왕조, 쩐 왕조, 후 레 왕조 등)",
        continent: "아시아",
